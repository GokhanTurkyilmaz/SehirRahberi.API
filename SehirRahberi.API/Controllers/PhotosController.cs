...
namespace SehirRahberi.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        private IOptions<CloudDinarySettings> _cloudinaryConfig;

        Cloudinary _cloudinary;
        public PhotosController(IAppRepository appRepository, IMapper mapper, IOptions<CloudDinarySettings> cloudinaryConfig)
        {
            ...
            Account account = new Account(
                _cloudinaryConfig.Value.ClouudName,
